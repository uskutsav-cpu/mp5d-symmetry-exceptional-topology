...
TABLE_II = [
    {
        ...
        "m1": 0,
        "m2": 0,
        "omega_ref": C(0.53384, -0.38338),
        "omega_MM": C(0.534406, -0.383241),
    ...
    },
    {
        ...
        "m1": 1,
        "m2": 0,
        "omega_ref": C(1.01602, -0.36233),
        "omega_MM": C(1.01620, -0.362074),
    ...
    },
    {
        ...
        "m1": 1,
        "m2": 1,
        "omega_ref": C(1.51057, -0.35754),
        "omega_MM": C(1.51055, -0.357371),
    ...
    },
    {
        ...
        "m1": 1,
        "m2": 1,
        "omega_ref": C(2.565177, -0.353047),
        "omega_MM": C(2.5651, -0.353033),
    ...
    },
    {
        ...
        "m1": 1,
        "m2": 0,
        "omega_ref": C(2.178379, -0.340853),
        "omega_MM": C(2.17821, -0.340858),
    ...
    # disagreement with our solver); with the correct reading we agree to 4e-6.
    {
        ...
        "m1": 1,
        "m2": 1,
        "omega_ref": C(2.609174, -0.348709),
        "omega_MM": C(2.60908, -0.348761),
...
TABLE_III = [
    {
        ...
        "m1": 1,
        "m2": 1,
        "omega_MM": C(1.6812, -0.347026),
        "omega_CFM": C(1.68112, -0.3472),
    },
    {
        "a": 0.4,
        "b": 0.2,
        ...
        "m1": 1,
        "m2": 1,
        "omega_MM": C(1.8222, -0.311043),
        "omega_CFM": C(1.82222, -0.311152),
    },
    {
        "a": 0.3,
        "b": 0.1,
        ...
        "m1": 1,
        "m2": 1,
        "omega_MM": C(2.63435, -0.349055),
        "omega_CFM": C(2.6344, -0.349097),
    },
]
...
def main() -> None:
    ...
    common = {
        "source": {
            ...
            "title": (
                "Quasinormal modes of massive scalar fields in five-dimensional "
    ...
    (OUT / "table_ii.json").write_text(
        json.dumps(
            {
                **common,
                "table": "II",
                "caption": "Comparison with literature. M=1, b=0 except last row.",
                "records": TABLE_II,
            },
            indent=2,
        )
    ...
    (OUT / "table_iii.json").write_text(
        json.dumps(
            {
                **common,
                "table": "III",
                "caption": "Two-spin comparison, M=1, m1=m2=1.",
                "records": TABLE_III,
            },
            indent=2,
        )
    ...
    (OUT / "table_iv.json").write_text(
        json.dumps(
            {
                **common,
                "table": "IV",
                "caption": "k=0, m1=m2=1, mu=0.1 grid.",
                "records": grid_records(TABLE_IV, 0, 1, 1, 0.1, "IV"),
            },
            indent=2,
        )
        + "\n"
    )
    (OUT / "table_v.json").write_text(
        json.dumps(
            {
                **common,
                "table": "V",
                "caption": "k=1, m1=1, m2=0, mu=0.1 grid.",
                "records": grid_records(TABLE_V, 1, 1, 0, 0.1, "V"),
            },
            indent=2,
        )
        + "\n"
    )
    (OUT / "table_vi.json").write_text(
        json.dumps(
            {
                **common,
                "table": "VI",
                "caption": "k=1, m1=0, m2=1, mu=0.1 grid.",
                "records": grid_records(TABLE_VI, 1, 0, 1, 0.1, "VI"),
            },
            indent=2,
        )
        + "\n"
    )
    (OUT / "table_vii.json").write_text(
        json.dumps(
            {
                **common,
                "table": "VII",
                "caption": "k=m1=m2=1, mu=0.1 grid.",
                "records": grid_records(TABLE_VII, 1, 1, 1, 0.1, "VII"),
            },
            indent=2,
        )
        + "\n"
