...
\begin{tabular}{llccl}
\toprule
Solver & Formulation & Recurrence-free & Validated domain & Known failure \\
\midrule
A & Leaver continued fraction, Gaussian-reduced & no &
  $r_-\le0.2287$, extremality $\ge0.294$ &
  drifts $2$--$6\times10^{-4}$/depth doubling in the \\
  & & & & quasiresonant regime \\
